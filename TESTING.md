...
* The site has been tested in Lighthouse tools with accessibility results of 96% for all pages and performance results differing in the span between 67% and 82%. Performance testing in Lighthouse is only an estimate and is affected by local factors such as computer performance and internet connection. Best practise has given the result of around 93% for different pages.
